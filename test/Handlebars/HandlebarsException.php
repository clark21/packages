 ...
 */
class Cradle_Handlebars_HandlebarsException_Test extends PHPUnit_Framework_TestCase
{
    /**
     ...
     * @todo   Implement testForMissingClosing().
     */
     ...
     * @todo   Implement testForUnknownEnd().
     */
     ...
     * @todo   Implement testForCompileError().
     */
